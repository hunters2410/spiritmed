...
def main():
    ...
    print(f" - Total Prescriptions : {len(prescriptions_list)} (Matched Patient: {matched_count}, Unmatched: {unmatched_count})")
    print(f" - Total Unique Meds  : {len(medicines_map)}")
    print(f" - Total Presc Items  : {len(items_list)}")
