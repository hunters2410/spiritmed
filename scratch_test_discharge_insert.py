...
payload = json.dumps([{
    ...
    "doctor_id": doctor_id,
    "admission_date": "2026-08-09T00:00:00Z",
    "discharge_date": "2026-08-09T00:00:00Z",
    "reason_for_admission": "Test reason",
    "treatment_summary": "Test treatment",
    "discharge_diagnosis": "Test diagnosis",
    "follow_up_instructions": "Test follow up",
    "recipient": "Test Recipient",
    "medical_history": "Test history",
    "treatment_done": "Test treatment done",
...
try:
    with urllib.request.urlopen(req) as resp:
        ...
        print("DISCHARGE INSERT TEST SUCCESS:", res)
    
    # Delete test record
    req_del = urllib.request.Request(
        f"{SUPABASE_URL}/rest/v1/discharge_summaries?id=eq.{test_id}",
        headers={"apikey": SERVICE_ROLE_KEY, "Authorization": f"Bearer {SERVICE_ROLE_KEY}"},
        method="DELETE"
    )
    with urllib.request.urlopen(req_del) as resp:
        print("DISCHARGE DELETE TEST CLEANUP SUCCESS")
except urllib.error.HTTPError as e:
    print("DISCHARGE INSERT TEST ERROR:", e.read().decode('utf-8'))
