...
import { Search, Eye, Phone, Mail, Calendar, Download, Filter, UserMinus, X, FileSpreadsheet, FileJson, ChevronLeft, ChevronRight, FileText, Plus, History } from 'lucide-react';
...
export function DischargedPatients() {
  ...
  const loadPatients = async () => {
    ...
    try {
      ...
      const patientsWithDetails = allPatients.map((p: any) => ({
        ...p,
  ...
  const exportToCSV = () => {
    const headers = ['Patient Number', 'Full Name', 'Age', 'Gender', 'Phone', 'Email', 'Blood Group', 'Discharge Date'];
    ...
    a.href = url;
    a.download = `discharged_patients_${new Date().toISOString().split('T')[0]}.csv`;
    a.click();
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-xl max-w-2xl w-full p-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white">Discharged Patient Details</h2>
              <button
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4 pb-4 border-b border-gray-200 dark:border-gray-700">
                <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center">
                  <UserMinus className="w-8 h-8 text-blue-600 dark:text-blue-400" />
                </div>
                <div>
