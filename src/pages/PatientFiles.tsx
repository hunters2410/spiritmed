      ...
      <div className="md:hidden space-y-3">
        {filteredFiles.length === 0 ? (
          ...
          filteredFiles.map((file) => (
            <div key={file.id} className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700 shadow-xs space-y-3">
              <div className="flex items-start justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="font-bold text-sm text-gray-900 dark:text-white truncate">{file.title || file.file_name}</h3>
              ...
              <div className="text-xs pt-2 border-t border-gray-100 dark:border-gray-700 space-y-1">
              ...
              <div className="pt-2 border-t border-gray-100 dark:border-gray-700 flex justify-end space-x-2">
                <button
                  onClick={() => handleDownload(file)}
                  className="flex items-center space-x-1 px-3 py-1.5 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-lg text-xs font-bold hover:bg-blue-100 transition"
                >
                ...
                <button
                  ...
                  className="flex items-center space-x-1 px-3 py-1.5 bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded-lg text-xs font-bold hover:bg-red-100 transition"
                >
          ...
          <table className="w-full border-collapse">
            ...
            <tbody className="bg-white dark:bg-gray-800">
              {filteredFiles.length === 0 ? (
                ...
                filteredFiles.map((file) => (
                  <tr key={file.id} className="hover:bg-gray-100 dark:hover:bg-gray-700 transition">
