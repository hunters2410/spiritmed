...
import { Plus, Search, Edit2, Eye, Filter, X, Users, Trash2, Mail, Phone, MapPin, Building2, ChevronLeft, ChevronRight } from 'lucide-react';
                  ...
                  <tr key={doctor.id} className="hover:bg-gray-50 dark:hover:bg-gray-900/30 transition">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <div className="text-sm font-bold text-gray-900 dark:text-white">{doctor.name || doctor.full_name}</div>
                          {doctor.address && (
