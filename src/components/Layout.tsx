...
export function Layout({ children }: LayoutProps) {
  ...
  const navigationGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Deceased Patients', icon: Skull, path: '/patients/deceased', module: 'patients' },
        { label: 'Discharged Patients', icon: UserMinus, path: '/patients/discharged', module: 'patients' },
        { label: 'Patient Files', icon: FolderOpen, path: '/patient-files', module: 'patients' },
        { label: 'File Number Pool', icon: FileText, path: '/patient-file-pool', module: 'patients' },
      ]
    },
    {
      title: 'Appointment',
      items: [
        ...
        { label: 'Appointment Calendar', icon: CalendarCheck, path: '/appointments/calendar', module: 'appointments' },
        { label: 'Appointment Schedule', icon: Clock, path: '/appointments/schedule', module: 'appointments' },
        { label: 'Online Booking', icon: Globe, path: '/appointments/online-booking', module: 'appointments' },
        { label: 'Appointment Reports', icon: BarChart3, path: '/appointments/reports', module: 'appointments' },
      ]
    },
    {
      title: 'Medical Records',
      items: [
        { label: 'Consultations', icon: Stethoscope, path: '/consultations', module: 'medical_records' },
        { label: 'Prescriptions', icon: Pill, path: '/prescriptions', module: 'medical_records' },
        { label: 'Vital Signs', icon: Activity, path: '/vital-signs', module: 'medical_records' },
        { label: 'Lab Results', icon: Microscope, path: '/lab-results', module: 'medical_records' },
        { label: 'Follow-ups', icon: HeartPulse, path: '/follow-ups', module: 'medical_records' },
      ]
    },
    {
      title: 'Clinical Reports',
      items: [
        { label: 'Medical Reports', icon: FileText, path: '/medical-reports', module: 'clinical_reports' },
        { label: 'Discharge Summaries', icon: FileCheck, path: '/discharge-summaries', module: 'clinical_reports' },
        { label: 'Referral Forms', icon: FileSignature, path: '/referral-forms', module: 'clinical_reports' },
        { label: 'Operation Reports', icon: ClipboardCheck, path: '/operation-reports', module: 'clinical_reports' },
        { label: 'Medical Certificates', icon: ScrollText, path: '/medical-certificates', module: 'clinical_reports' },
        { label: 'Admission Letters', icon: FilePlus, path: '/admission-letters', module: 'clinical_reports' },
      ]
    },
    {
      title: 'Prescription Items',
      items: [
        { label: 'Medicines', icon: Pill, path: '/medicines', module: 'medical_records' },
        { label: 'Frequency', icon: Clock, path: '/medicine-frequencies', module: 'medical_records' },
      ]
    },
    {
      title: 'Clinical Setup',
      items: [
        { label: 'Complaints', icon: MessageSquare, path: '/complaints', module: 'clinical_setup' },
        { label: 'Investigations', icon: Microscope, path: '/investigations', module: 'clinical_setup' },
        { label: 'Diagnoses', icon: Activity, path: '/diagnoses', module: 'clinical_setup' },
        { label: 'Histology', icon: FlaskConical, path: '/histology', module: 'clinical_setup' },
        { label: 'Anaesthetists', icon: UserCheck, path: '/anaesthetists', module: 'clinical_setup' },
        { label: 'Surgical Procedures', icon: Activity, path: '/surgical-procedures', module: 'clinical_setup' },
        { label: 'Assistants', icon: UserPlus, path: '/assistants', module: 'clinical_setup' },
        { label: 'Hospitals', icon: Building2, path: '/hospitals', module: 'clinical_setup' },
      ]
    },
    {
      ...
      items: [
        ...
        { label: 'Payment Procedures', icon: DollarSign, path: '/payment-procedures', module: 'billing' },
        { label: 'Estimate Bill', icon: CreditCard, path: '/estimates', module: 'billing' },
        { label: 'Payments', icon: Wallet, path: '/payments', module: 'billing' },
        { label: 'Expenses', icon: DollarSign, path: '/expenses', module: 'billing' },
        { label: 'Expense Categories', icon: Layers, path: '/expense-categories', module: 'billing' },
        { label: 'Accounting', icon: Calculator, path: '/accounting', module: 'billing' },
      ]
    },
    {
      ...
      items: [
        ...
        { label: 'Suppliers', icon: Building2, path: '/suppliers', module: 'inventory' },
        { label: 'Inventory Categories', icon: Layers, path: '/inventory/categories', module: 'inventory' },
        { label: 'Inventory Units', icon: Ruler, path: '/inventory/units', module: 'inventory' },
        { label: 'Hospital Files', icon: Folder, path: '/hospital-files', module: 'inventory' },
      ]
    },
    {
      ...
      items: [
        ...
        { label: 'Roles', icon: Shield, path: '/roles', module: 'staff' },
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Referral Doctors', icon: Users, path: '/referral-doctors', module: 'medical_records' },
      ]
    },
    {
      title: 'Communication',
      items: [
        { label: 'Internal Chats', icon: MessageSquare, path: '/chats', module: 'communication' },
        { label: 'Notifications', icon: Bell, path: '/notifications', module: 'communication' },
        { label: 'Email Management', icon: Mail, path: '/emails', module: 'communication' },
        { label: 'SMS Management', icon: Send, path: '/sms', module: 'communication' },
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Profile', icon: User, path: '/profile', module: 'dashboard' },
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
      ...
      <aside className={`fixed top-0 left-0 h-full bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 z-50 transform transition-all lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} ${sidebarCollapsed ? 'lg:w-16' : 'lg:w-72'} w-72`}>
      ...
      <div className={`transition-all ${sidebarCollapsed ? 'lg:pl-16' : 'lg:pl-72'}`}>
        <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30 shadow-xs">
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 px-2 py-1.5 flex items-center justify-around shadow-lg">
        <a
          href="/dashboard"
