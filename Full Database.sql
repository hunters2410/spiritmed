...
CREATE TABLE public.admission_forms (
  ...
  CONSTRAINT admission_forms_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT admission_forms_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id),
  CONSTRAINT admission_forms_doctor_id_fkey FOREIGN KEY (doctor_id) REFERENCES public.users(id),
  CONSTRAINT admission_forms_diagnosis_id_fkey FOREIGN KEY (diagnosis_id) REFERENCES public.diagnoses(id),
  CONSTRAINT admission_forms_hospital_id_fkey FOREIGN KEY (hospital_id) REFERENCES public.hospitals(id)
);
CREATE TABLE public.admission_letters (
  ...
  CONSTRAINT admission_letters_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT admission_letters_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id),
  CONSTRAINT admission_letters_doctor_id_fkey FOREIGN KEY (doctor_id) REFERENCES public.users(id)
);
CREATE TABLE public.anaesthetists (
  ...
  CONSTRAINT anaesthetists_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
CREATE TABLE public.appointment_slots (
  ...
  CONSTRAINT appointment_slots_doctor_id_fkey FOREIGN KEY (doctor_id) REFERENCES auth.users(id),
  CONSTRAINT appointment_slots_appointment_id_fkey FOREIGN KEY (appointment_id) REFERENCES public.appointments(id)
);
...
CREATE TABLE public.assistants (
  ...
  CONSTRAINT assistants_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
...
CREATE TABLE public.bill_items (
  ...
  CONSTRAINT invoice_items_invoice_id_fkey FOREIGN KEY (bill_id) REFERENCES public.bills(id)
);
CREATE TABLE public.bills (
  ...
  CONSTRAINT bills_medical_aid_id_fkey FOREIGN KEY (medical_aid_id) REFERENCES public.medical_aids(id)
);
...
CREATE TABLE public.chat_conversations (
  ...
  CONSTRAINT chat_conversations_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
...
CREATE TABLE public.consultations (
  ...
  CONSTRAINT consultations_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  ...
  CONSTRAINT consultations_doctor_id_fkey FOREIGN KEY (doctor_id) REFERENCES public.users(id),
  CONSTRAINT consultations_referred_by_fkey FOREIGN KEY (referred_by) REFERENCES public.referral_doctors(id)
);
CREATE TABLE public.diagnoses (
  ...
  CONSTRAINT diagnoses_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
CREATE TABLE public.discharge_summaries (
  ...
  created_at timestamp with time zone DEFAULT now(),
  diagnosis_ids ARRAY DEFAULT '{}'::uuid[],
  diagnosis_id uuid,
  recipient text,
  diagnosis_text text,
  medical_history text,
  ...
  CONSTRAINT discharge_summaries_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT discharge_summaries_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id),
  CONSTRAINT discharge_summaries_doctor_id_fkey FOREIGN KEY (doctor_id) REFERENCES public.users(id),
  CONSTRAINT discharge_summaries_diagnosis_id_fkey FOREIGN KEY (diagnosis_id) REFERENCES public.diagnoses(id)
);
CREATE TABLE public.doctor_availability (
  ...
  CONSTRAINT doctor_availability_doctor_id_fkey FOREIGN KEY (doctor_id) REFERENCES auth.users(id)
);
CREATE TABLE public.doctor_schedules (
  ...
  CONSTRAINT doctor_schedules_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
CREATE TABLE public.edit_approval_requests (
  ...
  CONSTRAINT edit_approval_requests_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT edit_approval_requests_requestor_id_fkey FOREIGN KEY (requestor_id) REFERENCES public.users(id),
  CONSTRAINT edit_approval_requests_reviewed_by_fkey FOREIGN KEY (reviewed_by) REFERENCES public.users(id)
);
CREATE TABLE public.email_logs (
  ...
  CONSTRAINT email_logs_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT email_logs_sender_id_fkey FOREIGN KEY (sender_id) REFERENCES public.users(id)
);
...
CREATE TABLE public.estimate_bill_items (
  ...
  CONSTRAINT patient_bill_items_bill_id_fkey FOREIGN KEY (estimate_id) REFERENCES public.estimate_bills(id),
  CONSTRAINT patient_bill_items_procedure_id_fkey FOREIGN KEY (procedure_id) REFERENCES public.payment_procedures(id)
);
CREATE TABLE public.estimate_bills (
  ...
  CONSTRAINT patient_bills_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT patient_bills_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id),
  CONSTRAINT patient_bills_medical_aid_id_fkey FOREIGN KEY (medical_aid_id) REFERENCES public.medical_aids(id),
  CONSTRAINT patient_bills_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id),
  CONSTRAINT patient_bills_converted_invoice_id_fkey FOREIGN KEY (converted_invoice_id) REFERENCES public.bills(id)
);
...
CREATE TABLE public.file_number_pool (
  ...
  CONSTRAINT file_number_pool_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
CREATE TABLE public.follow_ups (
  ...
  CONSTRAINT follow_ups_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT follow_ups_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id),
  CONSTRAINT follow_ups_doctor_id_fkey FOREIGN KEY (doctor_id) REFERENCES public.users(id),
...
CREATE TABLE public.histology_types (
  ...
  CONSTRAINT histology_types_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
CREATE TABLE public.holidays (
  ...
  CONSTRAINT holidays_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
CREATE TABLE public.hospital_files (
  ...
  CONSTRAINT hospital_files_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT hospital_files_uploaded_by_fkey FOREIGN KEY (uploaded_by) REFERENCES public.users(id)
);
CREATE TABLE public.hospitals (
  ...
  CONSTRAINT hospitals_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
CREATE TABLE public.internal_chats (
  ...
  CONSTRAINT internal_chats_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT internal_chats_sender_id_fkey FOREIGN KEY (sender_id) REFERENCES public.users(id),
  CONSTRAINT internal_chats_receiver_id_fkey FOREIGN KEY (receiver_id) REFERENCES public.users(id)
);
...
CREATE TABLE public.inventory_items (
  ...
  CONSTRAINT inventory_items_unit_id_fkey FOREIGN KEY (unit_id) REFERENCES public.inventory_units(id),
...
CREATE TABLE public.inventory_units (
  ...
  CONSTRAINT inventory_units_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
CREATE TABLE public.investigations (
  ...
  CONSTRAINT investigations_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
...
CREATE TABLE public.lab_results (
  ...
  CONSTRAINT lab_results_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT lab_results_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id),
  CONSTRAINT lab_results_ordered_by_fkey FOREIGN KEY (ordered_by) REFERENCES public.users(id),
  CONSTRAINT lab_results_histology_type_id_fkey FOREIGN KEY (histology_type_id) REFERENCES public.histology_types(id)
);
...
CREATE TABLE public.medical_aids (
  ...
  CONSTRAINT medical_aids_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
CREATE TABLE public.medical_certificates (
  ...
  CONSTRAINT medical_certificates_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT medical_certificates_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id),
  CONSTRAINT medical_certificates_doctor_id_fkey FOREIGN KEY (doctor_id) REFERENCES public.users(id)
);
CREATE TABLE public.medical_reports (
  ...
  CONSTRAINT medical_reports_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT medical_reports_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id),
  CONSTRAINT medical_reports_doctor_id_fkey FOREIGN KEY (doctor_id) REFERENCES public.users(id),
  CONSTRAINT medical_reports_diagnosis_id_fkey FOREIGN KEY (diagnosis_id) REFERENCES public.diagnoses(id)
);
CREATE TABLE public.medicine_frequencies (
  ...
  CONSTRAINT medicine_frequencies_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
CREATE TABLE public.medicines (
  ...
  CONSTRAINT medicines_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT medicines_frequency_id_fkey FOREIGN KEY (frequency_id) REFERENCES public.medicine_frequencies(id)
);
...
CREATE TABLE public.online_bookings (
  ...
  CONSTRAINT online_bookings_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT online_bookings_doctor_id_fkey FOREIGN KEY (doctor_id) REFERENCES public.users(id),
  CONSTRAINT online_bookings_slot_id_fkey FOREIGN KEY (slot_id) REFERENCES public.appointment_slots(id)
);
CREATE TABLE public.operation_reports (
  ...
  CONSTRAINT operation_reports_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT operation_reports_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id),
  CONSTRAINT operation_reports_surgeon_id_fkey FOREIGN KEY (surgeon_id) REFERENCES public.users(id),
  CONSTRAINT operation_reports_hospital_id_fkey FOREIGN KEY (hospital_id) REFERENCES public.hospitals(id),
  CONSTRAINT operation_reports_anaesthetist_id_fkey FOREIGN KEY (anaesthetist_id) REFERENCES public.anaesthetists(id),
  CONSTRAINT operation_reports_assistant_id_fkey FOREIGN KEY (assistant_id) REFERENCES public.assistants(id),
  CONSTRAINT operation_reports_procedure_id_fkey FOREIGN KEY (procedure_id) REFERENCES public.surgical_procedures(id)
);
CREATE TABLE public.patient_files (
  ...
  CONSTRAINT patient_files_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT patient_files_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id),
  CONSTRAINT patient_files_uploaded_by_fkey FOREIGN KEY (uploaded_by) REFERENCES public.users(id)
);
CREATE TABLE public.patient_resources (
  ...
  CONSTRAINT patient_resources_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id),
  CONSTRAINT patient_resources_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT patient_resources_shared_by_fkey FOREIGN KEY (shared_by) REFERENCES public.users(id)
);
CREATE TABLE public.patient_temporary_db (
  ...
  CONSTRAINT patient_temporary_db_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT patient_temporary_db_medical_aid_id_fkey FOREIGN KEY (medical_aid_id) REFERENCES public.medical_aids(id),
  CONSTRAINT patient_temporary_db_referral_doctor_id_fkey FOREIGN KEY (referral_doctor_id) REFERENCES public.referral_doctors(id)
);
CREATE TABLE public.patients (
  ...
  CONSTRAINT patients_medical_aid_id_fkey FOREIGN KEY (medical_aid_id) REFERENCES public.medical_aids(id),
  CONSTRAINT patients_doctor_id_fkey FOREIGN KEY (doctor_id) REFERENCES public.users(id),
  CONSTRAINT patients_referral_doctor_id_fkey FOREIGN KEY (referral_doctor_id) REFERENCES public.referral_doctors(id)
);
CREATE TABLE public.payment_procedures (
  ...
  CONSTRAINT payment_procedures_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
CREATE TABLE public.payments (
  ...
  CONSTRAINT payments_invoice_id_fkey FOREIGN KEY (bill_id) REFERENCES public.bills(id),
...
CREATE TABLE public.payroll (
  ...
  CONSTRAINT payroll_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT payroll_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id),
  CONSTRAINT payroll_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id)
);
CREATE TABLE public.payroll_settings (
  ...
  CONSTRAINT payroll_settings_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
...
CREATE TABLE public.prescriptions (
  ...
  CONSTRAINT prescriptions_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
...
CREATE TABLE public.referral_doctors (
  ...
  CONSTRAINT referral_doctors_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
CREATE TABLE public.referral_forms (
  ...
  CONSTRAINT referral_forms_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT referral_forms_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id),
  CONSTRAINT referral_forms_referring_doctor_id_fkey FOREIGN KEY (referring_doctor_id) REFERENCES public.users(id),
  CONSTRAINT referral_forms_referred_to_doctor_id_fkey FOREIGN KEY (referred_to_doctor_id) REFERENCES public.referral_doctors(id),
  CONSTRAINT referral_forms_doctor_id_fkey FOREIGN KEY (doctor_id) REFERENCES public.users(id)
);
CREATE TABLE public.roles (
  ...
  CONSTRAINT roles_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
...
CREATE TABLE public.salary_configurations (
  ...
  CONSTRAINT salary_configurations_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id),
  CONSTRAINT salary_configurations_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
CREATE TABLE public.sms_logs (
  ...
  CONSTRAINT sms_logs_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT sms_logs_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id)
);
CREATE TABLE public.sms_templates (
  ...
  CONSTRAINT sms_templates_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
CREATE TABLE public.staff_attendance (
  ...
  CONSTRAINT staff_attendance_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
...
CREATE TABLE public.surgical_procedures (
  ...
  CONSTRAINT surgical_procedures_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
CREATE TABLE public.system_configurations (
  ...
  CONSTRAINT system_configurations_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id),
  CONSTRAINT system_configurations_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(id),
  CONSTRAINT system_configurations_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id)
);
...
CREATE TABLE public.vital_signs (
  ...
  CONSTRAINT vital_signs_branch_id_fkey FOREIGN KEY (branch_id) REFERENCES public.branches(id),
  CONSTRAINT vital_signs_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id),
  CONSTRAINT vital_signs_recorded_by_fkey FOREIGN KEY (recorded_by) REFERENCES public.users(id)
);