    ...
    for idx, ch in enumerate(block):
        if ch == '(':
            ...
            if depth == 0 and start is not None:
                ...
                fns_to_check = ['2112', '2113', '2114', '2115', '2116', '0845', '1014']
                if fn in fns_to_check:
                    print(f"SQL row: id={cols[0]}, name='{name}', pid='{pid}', filenumber='{fn}', status='{cols[51]}', add_date='{cols[13]}'")
