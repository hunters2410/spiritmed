...
payload = json.dumps([{
    ...
    "operation_date": "2026-08-09T00:00:00Z",
    "operation_name": "Test Operation",
    "procedure_text": "Test procedure text",
    "procedure_description": "Test procedure description",
    "hospital": "Avenues Hospital",
    "anaesthetist": "Dr Mapfanyangira",
    "assistant": "Sr Katenjele",
    "post_op_plan": "Test post op plan",
    "follow_up_date": "2026-08-22",
    "follow_up_time": "11:15:00"
}]).encode('utf-8')
...
try:
    with urllib.request.urlopen(req) as resp:
        ...
        print("OPERATION INSERT TEST SUCCESS:", res)
    
    # Delete test record
    req_del = urllib.request.Request(
        f"{SUPABASE_URL}/rest/v1/operation_reports?id=eq.{test_id}",
        headers={"apikey": SERVICE_ROLE_KEY, "Authorization": f"Bearer {SERVICE_ROLE_KEY}"},
        method="DELETE"
    )
    with urllib.request.urlopen(req_del) as resp:
        print("OPERATION DELETE TEST CLEANUP SUCCESS")
except urllib.error.HTTPError as e:
    print("OPERATION INSERT TEST ERROR:", e.read().decode('utf-8'))
